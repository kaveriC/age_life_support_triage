...
In this dataset, `r covid_freq`% of your encounters were COVID+.
...
For reference, 48-hour maximum SOFA score at the beginning of the LSE predicted LSE mortality with an AUC of 0.60.
